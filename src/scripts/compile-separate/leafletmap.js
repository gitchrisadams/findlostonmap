...
// Lost:
myMarker.bindPopup("<h2>Lost my favorite penny!</h2>" + 
  "<h3>Area Lost:</h3>" + 
    "<p>Near mailbox</p>" + 
  "<h3>Description of item:</h3>" +
    "<p>Shiny penny circa 1976</p>" +
  "<h3>Contact/Return item:</h3>" +
    "<p>Christopher Adams</p>" +
    "<p>10A Coastal Court</p>" +
    "<p>Westerly, RI 02891</p>" +
    "<p><a href='mailto:chrismichaeladams@gmail.com'>chrismichaeladams@gmail.com</a></p>"
);

// Found:
foundMarker.bindPopup("<h2>Found a four leaf clover!</h2>" + 
  "<h3>Area Found:</h3>" + 
    "<p>In the grass.</p>" + 
  "<h3>Description of item:</h3>" +
    "<p>Looks kina like grass.</p>" +
  "<h3>Contact/Return item:</h3>" +
    "<p>Mr. Lucky Charms</p>" +
    "<p>End o' the Rainbow Circle</p>" +
    "<p>Pot of Gold, RI 02891</p>" +
    "<p><a href='mailto:#'>kidsAlwaysBeEatingMeLuckyCharms@fake.com</a></p>"
);

// Polyline outline the area item was lost on Coastal Court:
// Coordinates found w/ http://www.findlatitudeandlongitude.com/
var polyline = L.rectangle([[41.349059971982975, -71.76286697387695],
  [41.349068026106046, -71.76307618618011],
  [41.34884653735865, -71.7630922794342]
